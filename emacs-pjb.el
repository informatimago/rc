...
(custom-set-variables
 ...
 '(erc-autojoin-channels-alist '(("libera.chat" "#lisp" "#commonlisp" "#interlisp" "#clschool" "#lisp-es" "#abcl" "#ccl" "#ecl" "#sicl" "#clim" "#clcs" "#slime" "#lisppub" "#lispweb" "#lispgames" "#common-lisp.net" "#nyxt" "#cl-naive" "#clergo" "#emacs" "#org-mode" "#erc" "#gnus" "#hn" "#space" "#emacsfr-off") ("libera" "#lisp" "#commonlisp" "#interlisp" "#clschool" "#lisp-es" "#abcl" "#ccl" "#ecl" "#sicl" "#clim" "#clcs" "#slime" "#lisppub" "#lispweb" "#lispgames" "#common-lisp.net" "#nyxt" "#cl-naive" "#clergo" "#emacs" "#org-mode" "#erc" "#gnus" "#hn" "#space" "#emacsfr-off") ("freenode.org" "##Freelancers" "##binutils" "##cinema" "##coders" "##coding" "##france" "#lisp" "##lisp" "##sci-fi" "##smalltalk" "##tesla" "##teslamotors" "##teslamotors-staging" "##trains" "##ufo" "##workingset" "#abcl" "#bourguinux" "#ccl" "#cl" "#cl-bodge" "#clcs" "#clim" "#clschool" "#clus" "#cobol" "#cpp" "#cuda" "#ecl" "#emacs" "#emacsconf" "#emacsfr-off" "#haskell" "#haskell-fr" "#hn" "#iphonedev" "#iphonedev-chat" "#lisp-es" "#lispcafe" "#lispgames" "#lispweb" "#lispx" "#macintosh" "#macos9lives" "#qlisp" "#sicl" "#sicp" "#slime" "#space" "#swift-lang" "#synthesizers" "#tesla") ("disabled.freenode.org" "#macports") ("esper.net" "#SpaceX") ("sbde.fr" "#laboite" "#sbde") ("oftc.net" "#uml")))
 ...
 '(gnus-group-posting-charset-alist '(("^\\(no\\|fr\\)\\.[^,]*\\(,[\12]*\\(no\\|fr\\)\\.[^,]*\\)*$" iso-8859-15 (iso-8859-15)) ("^\\(fido7\\|relcom\\)\\.[^,]*\\(,[\12]*\\(fido7\\|relcom\\)\\.[^,]*\\)*$" koi8-r (koi8-r)) (message-this-is-mail nil nil) (message-this-is-news iso-8859-15 (iso-8859-15))))
 ...
 '(mail-default-headers "Organization: Informatimago\12X-Accept-Language:         fr, es, en\12MIME-Version: 1.0\12Content-Type: text/plain; charset=utf-8\12Content-Transfer-Encoding: 8bit\12Bcc: pjb@informatimago.com\12")
 ...
 '(mail-interactive t)
 '(mail-mode-hook '(mail-abbrevs-setup (lambda nil (set-buffer-file-coding-system 'utf-8 t t) (set-input-method default-input-method) (local-set-key "\11" 'expand-mail-aliases))))
 '(mail-self-blind t)
 ...
 '(package-selected-packages '(parinfer-rust-mode rust-mode rust-playground rustic use-package editorconfig compat with-editor transient dired-git-info docbook ox-gfm smalltalk-mode twittering-mode company-coq coq-commenter flycheck-swift flycheck-swift3 flycheck-swiftlint flycheck-swiftx ob-swift swift-helpful swift-playground-mode swift3-mode web-server pg polymode lsp-mode dash lsp-ui stack lsp-haskell stack-mode hyai hindent hi2 haskell-tab-indent haskell-snippets haskell-emacs-text haskell-emacs-base haskell-emacs flycheck-liquidhs flycheck-hdevtools flycheck-haskell dante ac-haskell-process shm retrie ormolu intero htmlize cobol-mode swift-mode haskell-mode helm markdown-mode inf-ruby w3m popup json emms paredit textmate smartparens robe jdee highlight-indentation flycheck enh-ruby-mode dash-at-point company column-marker auto-complete))
