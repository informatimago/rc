...
(custom-set-variables
 ...
 '(erc-autojoin-channels-alist '(("libera.chat" "#lisp" "#commonlisp" "#interlisp" "#clschool" "#lisp-es" "#abcl" "#ccl" "#ecl" "#sicl" "#clim" "#clcs" "#slime" "#lisppub" "#lispweb" "#lispgames" "#common-lisp.net" "#nyxt" "#cl-naive" "#clergo" "#emacs" "#org-mode" "#erc" "#gnus" "#hn" "#space" "#emacsfr-off")
 ...
 '(erc-nick '("tucktuck"))
 '(erc-nickserv-passwords '((libera (("ogamita" . "ogre-a-mite") ("pjb" . "a-new-discussion") ("tucktuck" . "bisbille")))))
 '(erc-notice-prefix "   *** ")
